interface BookingNotificationProData {
  clientName: string
  clientEmail: string
  serviceName: string
  date: string
...
export function bookingNotificationProEmail(data: BookingNotificationProData) {
  const subject = 'Nouveau rendez-vous confirmé'
                      ...
                      <tr>
                        <td style="padding: 0 0 16px; border-bottom: 1px solid #e5e5e5;">
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                              <td style="padding: 4px 0 0; font-size: 14px; color: #666666;">
                                ${data.clientEmail}
                              </td>
                            </tr>
                          </table>
